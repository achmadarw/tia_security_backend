...
ALTER TABLE IF EXISTS ONLY public.user_embeddings DROP CONSTRAINT IF EXISTS user_embeddings_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_shift_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_replaced_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.roster_assignments DROP CONSTRAINT IF EXISTS roster_assignments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.roster_assignments DROP CONSTRAINT IF EXISTS roster_assignments_pattern_id_fkey;
ALTER TABLE IF EXISTS ONLY public.roster_assignments DROP CONSTRAINT IF EXISTS roster_assignments_assigned_by_fkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_shift_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_block_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pending_attendance DROP CONSTRAINT IF EXISTS pending_attendance_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pending_attendance DROP CONSTRAINT IF EXISTS pending_attendance_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.patterns DROP CONSTRAINT IF EXISTS patterns_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.face_login_logs DROP CONSTRAINT IF EXISTS face_login_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.embedding_quality_history DROP CONSTRAINT IF EXISTS embedding_quality_history_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.embedding_quality_history DROP CONSTRAINT IF EXISTS embedding_quality_history_embedding_id_fkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_verification_log DROP CONSTRAINT IF EXISTS attendance_verification_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_verification_log DROP CONSTRAINT IF EXISTS attendance_verification_log_attendance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_shift_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_shift_assignment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_anomaly_log DROP CONSTRAINT IF EXISTS attendance_anomaly_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_anomaly_log DROP CONSTRAINT IF EXISTS attendance_anomaly_log_resolved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_anomaly_log DROP CONSTRAINT IF EXISTS attendance_anomaly_log_pending_attendance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_anomaly_log DROP CONSTRAINT IF EXISTS attendance_anomaly_log_attendance_id_fkey;
DROP TRIGGER IF EXISTS trigger_pending_attendance_updated_at ON public.pending_attendance;
DROP TRIGGER IF EXISTS trigger_anomaly_log_updated_at ON public.attendance_anomaly_log;
DROP INDEX IF EXISTS public.idx_users_role;
DROP INDEX IF EXISTS public.idx_users_phone;
DROP INDEX IF EXISTS public.idx_user_embeddings_user_id;
DROP INDEX IF EXISTS public.idx_user_embeddings_quality;
DROP INDEX IF EXISTS public.idx_user_embeddings_image_url;
DROP INDEX IF EXISTS public.idx_user_embeddings_active;
DROP INDEX IF EXISTS public.idx_shift_assignments_user_date;
DROP INDEX IF EXISTS public.idx_shift_assignments_date;
DROP INDEX IF EXISTS public.idx_reports_user;
DROP INDEX IF EXISTS public.idx_reports_date;
DROP INDEX IF EXISTS public.idx_reports_block;
DROP INDEX IF EXISTS public.idx_pending_attendance_user;
DROP INDEX IF EXISTS public.idx_pending_attendance_status;
DROP INDEX IF EXISTS public.idx_pending_attendance_reason;
DROP INDEX IF EXISTS public.idx_pending_attendance_check_time;
DROP INDEX IF EXISTS public.idx_patterns_created_by;
DROP INDEX IF EXISTS public.idx_patterns_active;
DROP INDEX IF EXISTS public.idx_face_login_logs_user_id;
DROP INDEX IF EXISTS public.idx_face_login_logs_success;
DROP INDEX IF EXISTS public.idx_face_login_logs_created_at;
DROP INDEX IF EXISTS public.idx_embedding_quality_history_user;
DROP INDEX IF EXISTS public.idx_embedding_quality_history_embedding;
DROP INDEX IF EXISTS public.idx_attendance_verification_log_user;
DROP INDEX IF EXISTS public.idx_attendance_verification_log_success;
DROP INDEX IF EXISTS public.idx_attendance_user;
DROP INDEX IF EXISTS public.idx_attendance_shift_assignment;
DROP INDEX IF EXISTS public.idx_attendance_face_verified;
DROP INDEX IF EXISTS public.idx_attendance_date;
DROP INDEX IF EXISTS public.idx_assignments_user_month;
DROP INDEX IF EXISTS public.idx_assignments_user;
DROP INDEX IF EXISTS public.idx_assignments_pattern;
DROP INDEX IF EXISTS public.idx_assignments_month;
DROP INDEX IF EXISTS public.idx_anomaly_log_user;
DROP INDEX IF EXISTS public.idx_anomaly_log_type;
DROP INDEX IF EXISTS public.idx_anomaly_log_status;
DROP INDEX IF EXISTS public.idx_anomaly_log_severity;
DROP INDEX IF EXISTS public.idx_anomaly_log_created;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_phone_key;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_key;
ALTER TABLE IF EXISTS ONLY public.user_embeddings DROP CONSTRAINT IF EXISTS user_embeddings_pkey;
ALTER TABLE IF EXISTS ONLY public.roster_assignments DROP CONSTRAINT IF EXISTS unique_assignment;
ALTER TABLE IF EXISTS ONLY public.shifts DROP CONSTRAINT IF EXISTS shifts_pkey;
ALTER TABLE IF EXISTS ONLY public.shifts DROP CONSTRAINT IF EXISTS shifts_code_unique;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_user_id_assignment_date_shift_id_key;
ALTER TABLE IF EXISTS ONLY public.shift_assignments DROP CONSTRAINT IF EXISTS shift_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.roster_assignments DROP CONSTRAINT IF EXISTS roster_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_pkey;
ALTER TABLE IF EXISTS ONLY public.pending_attendance DROP CONSTRAINT IF EXISTS pending_attendance_pkey;
ALTER TABLE IF EXISTS ONLY public.patterns DROP CONSTRAINT IF EXISTS patterns_pkey;
ALTER TABLE IF EXISTS ONLY public.face_login_logs DROP CONSTRAINT IF EXISTS face_login_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.embedding_quality_history DROP CONSTRAINT IF EXISTS embedding_quality_history_pkey;
ALTER TABLE IF EXISTS ONLY public.blocks DROP CONSTRAINT IF EXISTS blocks_pkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance_verification_log DROP CONSTRAINT IF EXISTS attendance_verification_log_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance_anomaly_log DROP CONSTRAINT IF EXISTS attendance_anomaly_log_pkey;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_embeddings ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.roster_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.reports ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pending_attendance ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.patterns ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.face_login_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.embedding_quality_history ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.blocks ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.audit_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.attendance_verification_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.attendance_anomaly_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.attendance ALTER COLUMN id DROP DEFAULT;
DROP VIEW IF EXISTS public.v_roster_assignments;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.user_embeddings_id_seq;
DROP TABLE IF EXISTS public.user_embeddings;
...
DROP SEQUENCE IF EXISTS public.roster_assignments_id_seq;
DROP TABLE IF EXISTS public.roster_assignments;
DROP SEQUENCE IF EXISTS public.reports_id_seq;
DROP TABLE IF EXISTS public.reports;
DROP SEQUENCE IF EXISTS public.pending_attendance_id_seq;
DROP TABLE IF EXISTS public.pending_attendance;
DROP SEQUENCE IF EXISTS public.patterns_id_seq;
DROP TABLE IF EXISTS public.patterns;
DROP SEQUENCE IF EXISTS public.face_login_logs_id_seq;
DROP TABLE IF EXISTS public.face_login_logs;
DROP SEQUENCE IF EXISTS public.embedding_quality_history_id_seq;
DROP TABLE IF EXISTS public.embedding_quality_history;
DROP SEQUENCE IF EXISTS public.blocks_id_seq;
DROP TABLE IF EXISTS public.blocks;
DROP SEQUENCE IF EXISTS public.audit_logs_id_seq;
DROP TABLE IF EXISTS public.audit_logs;
DROP SEQUENCE IF EXISTS public.attendance_verification_log_id_seq;
DROP TABLE IF EXISTS public.attendance_verification_log;
DROP SEQUENCE IF EXISTS public.attendance_id_seq;
DROP SEQUENCE IF EXISTS public.attendance_anomaly_log_id_seq;
DROP TABLE IF EXISTS public.attendance_anomaly_log;
DROP TABLE IF EXISTS public.attendance;
DROP FUNCTION IF EXISTS public.update_pending_attendance_updated_at();
DROP FUNCTION IF EXISTS public.update_anomaly_log_updated_at();
--
